...
**Claim:** The loop iteration counter is derived from the count of completed
tasks (`iteration = completed_count + 1`), so iteration numbers always reflect
actual progress and survive restarts.
