...
- [x] 4.3 Check that changes maintain clarity and don't introduce new ambiguities
- [x] 4.4 If other references to P6/P14 were found, update those as well
- [x] 4.5 Confirm no code changes are needed (documentation-only change)
