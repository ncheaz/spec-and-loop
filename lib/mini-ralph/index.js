...
const _supervisor = {
  _loadRuleSources: supervisor._loadRuleSources,
  _renderSupervisorPrompt: supervisor._renderSupervisorPrompt,
  _validateTaskStructure: supervisor._validateTaskStructure,
  _applyTaskPatch: supervisor._applyTaskPatch,
  _recoverSupervisorTmpFiles: supervisor._recoverSupervisorTmpFiles,
  _normalizeInvestigationHints: supervisor._normalizeInvestigationHints,
  _resolveRunLogPaths: supervisor._resolveRunLogPaths,
  _detectSupervisorLogReads: supervisor._detectSupervisorLogReads,
  runSupervisor: supervisor.runSupervisor,
  _parseSupervisorResponse: supervisor._parseSupervisorResponse,
};
